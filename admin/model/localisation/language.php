...
class ModelLocalisationLanguage extends Model {
    ...
    public function getLanguageData($languageCode, $path = null)
    {
        ...
        $language['lang_name'] = array_get($config, 'lang_name');
        $language['lang_locale'] = array_get($config, 'lang_locale');
        $language['name'] = array_get($config, 'lang_name');
        $language['locale'] = array_get($config, 'lang_locale');
