...
class ControllerCatalogProductDetail extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('catalog/product_detail', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$data['action'] = $this->url->link('catalog/product_detail', 'user_token=' . $this->session->data['user_token'], true);
