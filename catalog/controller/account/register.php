...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		// Country / Zone / Company for redesigned register form
	...
	private function validate() {
		// Auto-fill telephone with unique value to bypass OpenCart's telephone requirement
		if (empty($this->request->post['telephone'])) {
			$this->request->post['telephone'] = '555-' . sprintf('%07d', mt_rand(0, 9999999));
		}

		// Auto-copy confirm from password to bypass the confirmation match check
		...
		// Skip telephone uniqueness check — our auto-generated phone avoids collisions
		// (the original check is removed to support the simplified register form)
