        ...
        if (isset($this->request->cookie['tracking'])) {
            ...
            if ($affiliate_info) {
                ...
                foreach ($products as $product) {
                    ...
                    if ($commission) {
                        $commission_total += $product['total'];
                        $product_commission += ($product['total'] / 100) * $commission;
                    }
                }
                $order_data['affiliate_id'] = $affiliate_info['customer_id'];
                $order_data['commission'] = $product_commission + (($subtotal - $commission_total) / 100) * $affiliate_info['commission'];
            } else {
